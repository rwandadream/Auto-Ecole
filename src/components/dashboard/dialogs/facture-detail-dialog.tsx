    ...
    >
      <div className="space-y-5">
        ...
        <div className="overflow-hidden rounded-lg border border-border">
          <div className="grid grid-cols-1 divide-y divide-border bg-muted/40 sm:grid-cols-3 sm:divide-x sm:divide-y-0">
            <div className="px-4 py-3">
              <p className="text-xs uppercase tracking-wider text-muted-foreground">Montant total</p>
              <p className="mt-1 break-all text-sm font-bold text-foreground">{formatXOF(facture.montant)}</p>
            </div>
            <div className="px-4 py-3">
              <p className="text-xs uppercase tracking-wider text-muted-foreground">Avances payées</p>
              <p className="mt-1 break-all text-sm font-bold text-success">{formatXOF(facture.paye)}</p>
            </div>
            <div className="px-4 py-3">
              <p className="text-xs uppercase tracking-wider text-muted-foreground">Reste à payer</p>
              <p className={`mt-1 break-all text-sm font-bold ${facture.reste > 0 ? 'text-destructive' : 'text-muted-foreground'}`}>
